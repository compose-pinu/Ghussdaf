    ...
    for (const idx of indexes) {
      ...
      try {
        await api.sendMessage(
          `✅  𝐆𝐫𝐨𝐮𝐩 𝐇𝐚𝐬 𝐁𝐞𝐞𝐧 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐀𝐩𝐩𝐫𝐨𝐯𝐞𝐝 𝐁𝐲 ♡︎ 𝐒𝐤 𝐒𝐢𝐝𝐝𝐢𝐤 𝐇𝐞𝐫𝐞  ♡︎\n\n📁 𝐓𝐲𝐩𝐞 ${global.GoatBot.config.prefix}𝐇𝐞𝐥𝐩 𝐓𝐨 𝐒𝐞𝐞 𝐀𝐥𝐥 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬`,
          group.threadID
        );
 
        await api.changeNickname(
          `${global.GoatBot.config.nickNameBot || "🦋 𝐒𝐈𝐃𝐃𝐈𝐊-𝐁𝐎𝐓 ✨"}`,
          group.threadID,
